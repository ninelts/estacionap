...
<div class="animated fadeIn">
    <div>
        ...
        <div class=" s12 menu-reser">
            <a href="{{route('express')}}" class="boton" ><i class="fas fa-qrcode"></i> <span>Express</span> </a>
            <a href="{{route('vdiaria')}}" class="boton"><i class="fas fa-search"></i> <span>Diaria</span> </a>
